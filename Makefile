...
dit-mirror:
	env GOOS=linux GOARCH=amd64 go build -o releases/linux/amd64/dit-mirror cmd/dit-mirror/main.go
	env GOOS=linux GOARCH=arm64 go build -o releases/linux/arm64/dit-mirror cmd/dit-mirror/main.go
	env GOOS=darwin GOARCH=amd64 go build -o releases/darwin/amd64/dit-mirror cmd/dit-mirror/main.go
	env GOOS=darwin GOARCH=arm64 go build -o releases/darwin/arm64/dit-mirror cmd/dit-mirror/main.go
